...
def XPLMFindNavAid(inNameFragment,
    ...
    inNameFragment : string or None
    inIDFragment   : string or None
    inLat, inLon   : double or None
...
def XPLMGetNavAidInfo(inRef,
    ...
    The parameter is a single byte value 1 for true or 0 for false, not a
    string.
